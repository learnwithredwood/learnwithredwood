    ...
    <div className="grid grid-cols-12 gap-x-5">
      <div className="col-span-10 col-start-2 md:col-start-4 md:col-span-6">
        ...
        <p>
          ...
          <strong>
            trends, and the skills and resources you need to go from front-end
            to full-stack development, painlessly trends, and the skills and
        ...
        <p>
          They will also share personal career experiences and actionable
          insights, all designed to propel you to your next level.{' '}
        </p>
        ...
        <p>
          <strong>Space is limited so register today.</strong>
        </p>
      </div>
    </div>
  )
